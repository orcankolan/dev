...
MainWindow::MainWindow( QWidget *parent ):
    QWidget( parent )
{
    const double intervalLength = 5.0; // seconds
    ...
    d_frequencyKnob->setValue( 20.0 );

    d_intervalWheel = new WheelBox( "Displayed [s]", 1.0, 100.0, 1.0, this );
    d_intervalWheel->setValue( intervalLength );

    d_timerWheel = new WheelBox( "Sample Interval [ms]", 0.0, 50.0, 0.1, this );
    d_timerWheel->setValue( 24.0 );
